    ...
    return (
      <div className="flex flex-col gap-8 pb-10">
        <div>
          ...
          <h1 className="!text-2xl font-black text-[var(--foreground)] tracking-tight">Store Profile</h1>
        </div>
    ...
    return (
      <div className="flex flex-col gap-8 pb-10">
        ...
        <div className="card rounded-2xl border border-[var(--border)] bg-[var(--card-solid)] p-6 text-center py-12">
          ...
          <p className="text-[var(--foreground)] font-bold mb-2">We couldn't find a store for your account</p>
          <Link
            href="/create-shop"
    ...
    <div className="flex flex-col gap-8 pb-10">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          {store.isVerified && store.slug && (
            <Link
              href={`/stores/${store.slug}`}
              target="_blank"
              className="text-xs font-bold px-4 h-10 rounded-lg border border-[var(--border)] text-[var(--foreground-muted)] hover:bg-[var(--background-soft)] transition-colors flex items-center gap-1.5"
            >
